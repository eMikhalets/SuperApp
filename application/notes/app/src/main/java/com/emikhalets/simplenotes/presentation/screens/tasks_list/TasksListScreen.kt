...
fun TasksListScreen(
    ...
    ScreenContent(
        ...
        onAddTaskClick = { taskEntity = TaskEntity.empty() },
...
private fun ScreenContent(
    tasksList: List<TasksListWrapper>,
    checkedTasksList: List<TasksListWrapper>,
    checkedTasksVisible: Boolean,
    checkedTasksCollapsed: Boolean,
    onTaskClick: (TaskEntity) -> Unit,
    onCheckTask: (TaskEntity, Boolean) -> Unit,
    onCheckSubtask: (TaskEntity, SubtaskEntity, Boolean) -> Unit,
    onAddTaskClick: () -> Unit,
    ...
    AppTheme {
        ScreenContent(
            tasksList = listOf(
                TasksListWrapper(
                    TaskEntity(
                        ...
                        subtasks = listOf(
                            SubtaskEntity(taskId = 0, content = "Subtask content"),
                            SubtaskEntity(taskId = 0, content = "Subtask content"),
                            SubtaskEntity(taskId = 0, content = "Subtask content", checked = true),
                        )
                    )
                ),
                TasksListWrapper(TaskEntity(content = "Task content")),
                TasksListWrapper(TaskEntity(content = "Task content")),
                TasksListWrapper(TaskEntity(content = "Task content")),
            ),
            checkedTasksList = listOf(
                ...
                TasksListWrapper(TaskEntity(content = "Task content", checked = true)),
                TasksListWrapper(TaskEntity(content = "Task content", checked = true)),
                TasksListWrapper(TaskEntity(content = "Task content", checked = true)),
            ),
